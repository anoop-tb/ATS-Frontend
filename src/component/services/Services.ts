...
const EmployeeDetails = async(data:any[]) =>{
    ...
    const url = `${Constants.employeeDetailsServiceUrl}?search_id=yutrepoinmd4545&email_id=anoop.tb%40accionlabs.com&skills=react%2Cnode.js&exp_l=2&exp_h=5&location=mumbai&job_title=full%20stack`
    try{
